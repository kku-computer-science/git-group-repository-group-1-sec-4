...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        ActivityLog::create([
            ...
            'action' => 'create_user',
            'description' => 'User ' . auth()->user()->email . ' created a new user ID = ' . $user->id
        ]);
    ...
    public function show($id)
    {
        ...
        ActivityLog::create([
            ...
            'description' => 'User ' . auth()->user()->email . ' viewed user ID = ' . $id
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        ActivityLog::create([
            ...
            'role'       => auth()->user()->roles->pluck('name')->first() ?? null,
            'action'     => 'edit_user',
            'description' => 'User ' . auth()->user()->email . ' edited user ID = ' . $user->id
        ]);
        return redirect()->route('users.index')
