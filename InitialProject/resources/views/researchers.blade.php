...
<div class="container card-2">
    ...
    <span>
        <ion-icon name="caret-forward-outline" size="small"></ion-icon> {{ trans('message.' . $res->program_name_en) }}
    </span>
    <div class="d-flex">
        <div class="ml-auto">
                ...
                <div class="row g-0">
                    ...
                    <div class="col-sm-8 overflow-hidden"
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title">{{ $r->{'fname_' . app()->getLocale()} }}
                                {{ $r->{'lname_' . app()->getLocale()} }}, {{ $r->doctoral_degree }}
                                @else
                                <h5 class="card-title">{{ $r->{'fname_' . app()->getLocale()} }}
                                    {{ $r->{'lname_' . app()->getLocale()} }}
                                </h5>
                                @endif
