...
<div class="container card-2">
    <p class="title"><?php echo e(trans('message.researchers_title')); ?></p>
            ...
            <form class="row row-cols-lg-auto g-3" method="GET" action="<?php echo e(route('searchresearchers',['id'=>$res->id])); ?>">
                <div class="col-md-8">
                    <div class="input-group">
                        <input type="text" class="form-control" name="textsearch" placeholder="<?php echo e(trans('message.search_placeholder')); ?>">
                    </div>
                </div>
                <!-- <div class="col-12">
                ...
                <div class="col-md-4">
                    <button type="submit" class="btn btn-outline-primary"><?php echo e(trans('message.search_button')); ?></button>
                </div>
            </form>
        </div>
    </div>
                    ...
                    <div class="col-sm-8 overflow-hidden" style="text-overflow: clip; <?php if(app()->getLocale() == 'en'): ?> max-height: 220px; <?php else: ?> max-height: 210px;<?php endif; ?>">
                        <div class="card-body">
                            <?php if(app()->getLocale() == 'en'): ?>
                                ...
                                <?php elseif($r->doctoral_degree_cn == '博士'): ?>
                                <h5 class="card-title"><?php echo e($r->{'fname_'.app()->getLocale()}); ?> <?php echo e($r->{'lname_'.app()->getLocale()}); ?>, <?php echo e($r->doctoral_degree_cn); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\git-group-repository-group-1-sec-4\InitialProject\resources\views/researchers.blade.php ENDPATH**/ ?>