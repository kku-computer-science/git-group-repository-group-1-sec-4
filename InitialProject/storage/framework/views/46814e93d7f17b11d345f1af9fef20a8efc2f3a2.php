	...
	<!-- <div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-100">
				<form method="POST" class="login100-form validate-form" autocomplete="off" action="<?php echo e(route('login')); ?>">
					<?php echo csrf_field(); ?>
					...
					<div class="alert alert-danger alert-block ">
						...
						<strong><a><?php echo e($errors->first()); ?></a></strong>
					</div>
					<?php endif; ?>
	...
	<div class="form">
		...
		<div class="form-panel one">
			...
			<div class="form-content">
				<form method="POST" class="validate-form" autocomplete="off" action="<?php echo e(route('login')); ?>">
					<?php echo csrf_field(); ?>
					<?php if($errors->any()): ?>
					<div class=" alert alert-danger alert-block ">
						<button type=" button" class="close" data-dismiss="alert"></button>
...
</html><?php /**PATH C:\xampp\htdocs\git-group-repository-group-1-sec-4\InitialProject\resources\views/auth/login.blade.php ENDPATH**/ ?>